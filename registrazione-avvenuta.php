...
<p>Congratulazioni caro utente per esserti registrat<?php echo $lettera_sesso;?> con successo, inizia ad esplorare tutte le ricette di Chef Mario per gustarle in dolce compagnia!</p>
...
<ol class="breadcrumb">
<li><a href="index.php">Home</a></li>
<li><a href="registrazione.php">Library</a></li>
<li class="active">Registrazione Avvenuta</li>
</ol>
<!-- InstanceEndEditable -->
...
<p>Complimenti <?php echo $utente['nome'];?> per esserti registrat<?php echo $lettera_sesso;?> con successo.<br>
Manca solo un piccolo passaggio per completare la procedura di registrazione; controlla ora la tua casella di posta elettronica per confermare i tuoi dati.</p>

<a href="index.php" class="pulsanti-form margine-top">TORNA ALLA HOME</a>
</div>
</div>
<!-- InstanceEndEditable -->
