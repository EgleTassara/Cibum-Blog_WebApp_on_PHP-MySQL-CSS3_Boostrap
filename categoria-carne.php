...
<?php
$query_RS_ricette="SELECT * FROM ricette WHERE categoria='CARNE'";
...
$query_RS_pagricette="SELECT * FROM ricette WHERE categoria='CARNE' ORDER BY id DESC $limite";
...
<div class="jumbotron">
<h1>Le ricette per chi ama incondizionatamente la carne.</h1>
...
<li class="active">Ricette di Carne</li>
</ol>
<!-- InstanceEndEditable -->
...
<div class="col-md-9">
<div class="well">
<h1>Elenco ricette: a base di Carne</h1>
