...
<title>Recupera Password Step 1</title>
<!-- InstanceEndEditable -->
...
<div class="jumbotron">
<h1>Recupera Password Step 1</h1>
<p>Prima fase di 2 per recuperare la propria password, vi raccomandiamo di non condivedere, scrivere o inviare la vostra password a terzi.</p>
<p><a class="pulsanti-form" href="registrazione.php" role="button">LEGGI TUTTO</a></p>
</div>
<!-- InstanceEndEditable -->
...
<li class="active">Recupera password</li>
</ol>
<!-- InstanceEndEditable -->
...
<div class="col-md-9">
<div class="well">
<h2>Recupera la tua e-mail:</h2>

<form action="recupero-password-step2.php" method="get" name="formRecupero" id="formRecupero">

<div class="input-group input-group-lg">
<input name="email" type="email" id="email" placeholder="Inserisci la tua e-mail" class="recupera-mail">
</div>

<input type="submit" name="recupero" value="Recupera password" class="pulsanti-form center-block">
</form>
