...
<li><a href="chi-siamo.php">CHI SIAMO</a></li>
	<li  class="active"><a href="contatti.php">CONTATTI<span class="sr-only">(current)</span></a></li>
...
<div class="jumbotron">
  <h1>Contattaci</h1>
  <p>In questa sezione troverai il modulo per contattarci, ed esprire ogni tua idea, esigenza! Cosa aspetti inviaci le tue idee</p>
</div>
<ol class="breadcrumb">
...
<div class="col-md-9">
  <div class="well">
    <h1><span class="pacifico">Come contattarci:</span></h1>
    <hr>
    <p>Tel. 340 - 7921785<br>
      Tel. 352 - 9962439<br>
      <br>
      Oppure contattaci tramite i tuoi canali preferiti sui social o utilizza il modulo che trovi in fondo alla pagina!!!
      </p>
    <hr>
    <h2><span class="pacifico">Dove siamo:</span></h2>
    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7034.3272357840115!2d12.501648227566763!3d41.90247882071467!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x132f61a155278919%3A0xcff7cfeedef9410c!2sMcDonald&#39;s+Termini!5e0!3m2!1sit!2sit!4v1531236202091" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
    <hr>
    <div class="invia-mess">
      <h1>Oppure lasciaci un messaggio:</h1>
      <form>
        ...
        <textarea class="form-control" placeholder="Scrivi il testo del commento..."></textarea><br>
        <input type="submit" class="pulsanti-form" value="INVIA MESSAGGIO">
        </form>
      </div>
