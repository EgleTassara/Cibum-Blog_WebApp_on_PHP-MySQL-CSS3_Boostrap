	...
	<div data-role="page" data-theme="a">
		...
		<div data-role="content" data-theme="a">
            ...
            <ul data-role="listview" data-inset="true">
                ...
                <li style="background-color: #AB301F">
                    <p><img src="../images/<?php echo $row_RS_pagricette['foto'];?>" width="200" height="200" alt="" style="padding-top:  5px;"></p>
                    <h3 style="padding-left: 5px;"><?php echo $row_RS_pagricette['nome'];?></h3>
                    <p><?php echo $row_RS_pagricette['ingredienti'];?></p>
                    <p style="color: #FFFFFF;"><?php echo $row_RS_pagricette['procedimento'];?></p>
                    ...
                    <button>Tempo di preparazione: <?php echo $row_RS_pagricette['tempoPreparazione'];?> minuti</button>
                    <button>Tempi di cottura: <?php echo $row_RS_pagricette['cottura'];?> minuti</button>
            ...
            <span class="ui-li-count">Data inserimento: <?php echo $row_RS_pagricette['data'];?></span>
                <p class="ui-li-aside" style="color: #FFFFFF">Categoria: <?php echo $row_RS_pagricette['categoria'];?></p>
                <p>
                    <a href="mod-ricetta.php?codice=<?php echo $row_RS_pagricette['id'];?>&pag=<?php echo $_GET['pag'];?>" target="_self" style="color: #FFFFFF;">MODIFICA</a>
                    <a href="elimina-ricetta.php?codice=<?php echo $row_RS_pagricette['id'];?>" target="_self" style="color: #FFFFFF;">CANCELLA</a>
                </p>
            </a>
