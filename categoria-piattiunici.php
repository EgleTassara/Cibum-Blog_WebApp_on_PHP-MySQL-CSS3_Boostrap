...
<?php
$query_RS_ricette="SELECT * FROM ricette WHERE categoria='PIATTI UNICI'";
...
$query_RS_pagricette="SELECT * FROM ricette WHERE categoria='PIATTI UNICI' ORDER BY id DESC $limite";
...
<title>Ricette Piatti Unici</title>
<!-- InstanceEndEditable -->
...
<div class="jumbotron">
<h1>Tutto il gusto racchiuso il un singolo meraviglioso piatto.</h1>
...
<li class="active">Ricette Piatti Unici</li>
</ol>
<!-- InstanceEndEditable -->
...
<div class="col-md-9">
<div class="well">
<h1>Elenco ricette: Piatti Unici</h1>
...
<div class="btn-group" role="group">
    ...
    <button type="button" class="btn btn-danger">Tempo: <?php echo $row_RS_pagricette['tempoPreparazione'];?> minuti</button>
</div>
<p style="margin:15px 0;"><?php echo substr($row_RS_pagricette['procedimento'],0,350);?>...</p>
<a href="dettaglio-ricetta.php?codice=<?php echo $row_RS_pagricette['id'];?>" class="pulsanti-form" style="float:right; margin-top: 10px; margin-right:10px;">LEGGI TUTTO</a><br><br>
</div>
</li>
<hr>
