...
<?php
$query_RS_ricette="SELECT * FROM ricette WHERE categoria='DOLCI'";
...
$query_RS_pagricette="SELECT * FROM ricette WHERE categoria='DOLCI' ORDER BY id DESC $limite";
...
<title>Ricette a base di Dolci</title>
<!-- InstanceEndEditable -->
...
<div class="jumbotron">
<h1>Per chi non può mai fare a meno deli dolci.</h1>
...
<li class="active">Ricette a base si Dolci</li>
</ol>
<!-- InstanceEndEditable -->
